...
exports.myAccount=(req,res)=>{
        ...
        .then((item)=>{
                User.findOne()
                .then((user)=>{
                        res.render('user/myAccount',{item,user})
...
//         req.session.discountedBill = req.body.Bill
...
//     const newOrder = (method ,bill,coupon, sessionUser)=>{
//         return new Promise((resolve,reject)=>{
//                 const createorder = Cart.findOne({owner : sessionUser})
//                 .then((cartdetails)=>{
                       
//                         let newOrder = new Order({
//                                 owner : cartdetails.owner,
...
//                                 couponCode : coupon.couponCode || "",
//                                 couponValue : coupon.couponValue || "",
//                                 discountedBill : bill || cartdetails.bill
...
//     }
    ...
    exports.paypal = (req, res) => {
        ...
        'client_id': 'AZG0dEayLdXnSNTJOyOYq5p6n4G6aai2eHXlxDbcxhjqcILNYTwLT3sFZ_5wXtpHQe731rKsxR7YKz5x', 
        // please provide your client id here 
        'client_secret': 'EFTeCWCiJgB5zFpEkrawi_v-QMI5yxp4VjpuaMz0wERua3LtML-720Yzlk_P2M0b3sy9ylo_rY0sifms' // provide your client secret here 
        });
